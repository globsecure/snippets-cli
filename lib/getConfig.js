...
// config files
var CONFIG_FILES = ['.snippetrc.js', '.snippetrc.json', '.snippetrc'];
/**
 * get Config file
 * @param dir current dir
 */
var getConfigFromDir = function (dir) {
    return CONFIG_FILES.map(function (file) { return path.join(dir, file); }).find(util_1.isExisted) || null;
};
