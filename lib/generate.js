...
var generateTmpl = function (tmpl, name, target, filename, suffix) {
    ...
    var outputFile = path.resolve(target, "" + filename + fileExt);
    ...
    util_1.logSuccess(name + " generated in " + target + filename + fileExt);
    return true;
};
